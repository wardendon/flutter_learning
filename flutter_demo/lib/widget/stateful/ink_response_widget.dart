...
class InkResponseWidget extends StatefulWidget {
  const InkResponseWidget({Key? key}) : super(key: key);

  @override
  State<InkResponseWidget> createState() => _InkResponseWidgetState();
}

class _InkResponseWidgetState extends State<InkResponseWidget> {
  String _info = '⻓按可以变化';
  var _msg = 'Push';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  '水波纹的点击响应组件，接收点击、双击、⻓按、取消、高亮变化事件，可指定水波纹的颜色、半径、高亮、形状等属性。',
                  style: descStyle,
                ),
              ),
              Material(
