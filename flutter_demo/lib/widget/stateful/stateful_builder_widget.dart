...
class StatefulBuilderWidget extends StatelessWidget {
  const StatefulBuilderWidget({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  '可以监听一个值，当其变化时通过builder回调能重建界面，避免使用setState刷新。',
                  style: descStyle,
                ),
              ),
              Row(
              ...
              Container(
                ...
                child: const Text(
                  '需要传入 builder 属性来构造组件，在 builder 中可以是StateSetter 改变子组件的状态，从而不用创建新的状态类即可实现局部刷新。',
                  style: descStyle,
                ),
              ),
              StatefulBuilder(
